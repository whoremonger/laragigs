...
<x-card class="p-10 max-w-lg mx-auto mt-24">
  ...
  <form method="POST" action="/users">
    ...
    <div class="mb-6">
      ...
      <input type="password" class="border border-gray-200 rounded p-2 w-full" value="{{old('password')}}" name="password"/>
    ...
    <div class="mb-6">
      ...
      <input type="password" class="border border-gray-200 rounded p-2 w-full" value="{{old('password_confirmation')}}" name="password_confirmation"/>
